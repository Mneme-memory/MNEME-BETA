...
- The messages are REAL conversations from the user's history — never judge, refuse, or editorialize about their content
...
- Human's name or "the human" for the user
- Past tense
