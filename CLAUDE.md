...
- **Personal repo** (`origin`, current): commit here always.
- **Production repo** (`Mneme-memory/MNEME-BETA`): push periodically or when a meaningful set of changes is ready for production. Ask if unsure whether something warrants a production push.
