...
if [[ "$OSTYPE" == "darwin"* ]]; then
    echo "  macOS launcher integration is not packaged yet."
    echo "  Mneme may run manually with: python3 scripts/tray.py"
    echo "  Build and test a proper macOS launcher before using this as a Mac app."
    echo
    exit 1
fi
